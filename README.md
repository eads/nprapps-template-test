...
**TKTK: Describe nprapps-template-test here.**
...
```
cd nprapps-template-test
mkvirtualenv --no-site-packages nprapps-template-test
...
```
* * * * * ubuntu bash /home/ubuntu/apps/nprapps_template_test/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|nprapps-template-test|tweet|`location`||||
|nprapps-template-test|facebook|`location`||||
|nprapps-template-test|email|`location`||||
|nprapps-template-test|new-comment||||
|nprapps-template-test|open-share-discuss||||
|nprapps-template-test|close-share-discuss||||
|nprapps-template-test|summary-copied||||
|nprapps-template-test|featured-tweet-action|`action`||``tweet_url``|
|nprapps-template-test|featured-facebook-action|`action`||``post_url``|
